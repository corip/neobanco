...
let CardsRepository = class CardsRepository {
    repository;
    ...
    async updateStatus(requestId, status, retries, errorReason) {
...
exports.CardsRepository = CardsRepository = __decorate([
    ...
    __param(0, (0, typeorm_1.InjectRepository)(card_request_entity_1.CardRequestEntity)),
